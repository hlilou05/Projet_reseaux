...
class Menu():
    ...
    def display_main(self):
        if self.displayed:
            ...
            self.Join_game = Button_Menu(self.screen, self.mid_width, self.mid_height + (2 * GAP), 'Join Game')
            self.QUIT = Button_Menu(self.screen, self.mid_width, self.mid_height + (3 * GAP), 'Good Bye')
