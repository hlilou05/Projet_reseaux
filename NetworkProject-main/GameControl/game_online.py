...
class Game_Online:
    ...
    def drawIndex_Online(self, surface):
        ...
        top_right_rect = pg.Rect(half_width, 0, half_width, surface.get_height() // 2)
        ...
        draw_text(
            surface,
            'Jour: {}'.format(round(self.gameController.getDay())),
            25,
            (0,0,0),
            (top_right_rect.left, y_position)
        )
        ...
        draw_text(
            surface,
            'Nb de joueurs: {}'.format(len(connected_players)),
            25,
            (0,0,0),
