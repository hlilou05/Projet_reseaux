...
def join_room(screen, clock ):
    ...
    join_button_rect = pg.Rect( (screen.get_width() - button_width ) - 50, (screen.get_height() - button_height) - 50, button_width, button_height)
    etat = EtatJeu.getEtatJeuInstance()
    while etat.online_menu:
        ...
        if ip_port_dict["IP"] != "" and ip_port_dict["PORT"] != 0:
            draw_transparent_button("JOIN", join_button_rect, 1)
